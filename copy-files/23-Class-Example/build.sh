...
DEPENDENCE="23-Dependency-Package.jar"
PFOLDER=
PACKAGE=
...
jar cfem ../${SRC}.jar ${PACKAGE}${TRG_CLS} Manifest.txt $targets
cd ..
java -Xmx1G -Xss1G -jar $JAR -projectCP "./:./${SRC}.jar" -class ${PACKAGE}${TRG_CLS} -seed ${JOBID} \
     -Dsearch_budget=$SEC -Dstopping_condition=MaxTime > ${Home}/${SRC}.txt  2>&1
